...
if (completeOrderBtns) {
  completeOrderBtns.forEach(btn => btn.addEventListener("click", handleOrderComplete));
}

},{"../../node_modules/regenerator-runtime":"47I7E","./storeForm":"6novE","./productForm":"1BMhp","./cart":"5UFHA","./checkout":"qQPNU"}],"47I7E":[function(require,module,exports) {
/**
...
_parcelHelpers.export(exports, "createStore", function () {
  return createStore;
});
var _node_modulesAxios = require("../../node_modules/axios");
var _node_modulesAxiosDefault = _parcelHelpers.interopDefault(_node_modulesAxios);
const createStore = async form => {
  ...
  const image = (_document$querySelect = document.querySelector(".file-drop-input")) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.files;
  newStore.append("image", image[0]);
  await sendStoreData(newStore);
};
const sendStoreData = async data => {
  try {
    const res = await _node_modulesAxiosDefault.default.post(`/api/v1/stores`, data);
...
},{"../../node_modules/axios":"4BALY","@parcel/transformer-js/lib/esmodule-helpers.js":"Yi0gX"}],"4BALY":[function(require,module,exports) {
...
},{"./../utils":"2MOrv","./../core/settle":"17Zgn","../core/buildFullPath":"6YtPg","./../helpers/buildURL":"7aMyQ","./../../package.json":"1v88x","../core/createError":"6bGgc","../core/enhanceError":"1l3Er"}],"1v88x":[function(require,module,exports) {
...
},{}],"Yi0gX":[function(require,module,exports) {
"use strict";
...
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "createProduct", function () {
...
const createProduct = async form => {
  ...
  if (!form.title.value || !form.description.value || !form.price.value) {
    return _helpers.showAlert("error", "You must fill all required fields of this form", "productForm");
  }
  ...
  const images = (_document$querySelect = document.querySelector(".images")) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.files;
  if (images.length === 0 || images.length > 3) {
    return _helpers.showAlert("error", "You must upload at least one image or not more than three images", "productForm");
  }
...
const sendProductData = async data => {
  try {
    ...
    const res = await _node_modulesAxiosDefault.default.post("/api/v1/products", data);
    if (res.data.status === "success") {
...
},{"../../node_modules/axios":"4BALY","./helpers":"3HsGi","@parcel/transformer-js/lib/esmodule-helpers.js":"Yi0gX"}],"3HsGi":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "showAlert", function () {
  return showAlert;
});
_parcelHelpers.export(exports, "renderSpinner", function () {
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"Yi0gX"}],"5UFHA":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
class Cart {
  ...
  updateCart() {
    ...
    this.renderCartIcon();
    this.renderCartPage();
    setTimeout(() => _helpers.renderSpinner("updateCart", "remove"), 2000);
  }
  ...
  checkForDuplicates(product) {
    ...
    if (duplicate) {
      duplicate.orderQuantity += +(itemQtyEl === null || itemQtyEl === void 0 ? void 0 : itemQtyEl.value) || 1;
    }
    this._calcTotals();
    this.renderCartIcon();
    return duplicate;
...
},{"./helpers":"3HsGi","@parcel/transformer-js/lib/esmodule-helpers.js":"Yi0gX"}],"qQPNU":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "order", function () {
  return order;
});
var _cart = require("./cart");
var _helpers = require("./helpers");
...
},{"./cart":"5UFHA","./helpers":"3HsGi","@parcel/transformer-js/lib/esmodule-helpers.js":"Yi0gX"}]},["23iCI"], "23iCI", "parcelRequireae0f")
